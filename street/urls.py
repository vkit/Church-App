...
urlpatterns = [
    ...
    url(r'^kannada_list/$', views.KannadaResourceList.as_view()),
    url(r'^english_list/$', views.EnglishResourceList.as_view()),
    url(r'^tamil_list/$', views.TamilResourceList.as_view()),
